import { ButtonPrimary, ExifBar } from "@portfolio/aperture";
	...
	return (
		<div className="bg-black">
			<div className="max-w-screen-cnt container mx-auto grid grid-cols-1 md:grid-cols-2 items-center relative max-md:px-0 md:pr-0">
				<section className="py-10 max-md:text-center px-4 md:px-0">
					...
					<ButtonPrimary className="mt-5">Check it out</ButtonPrimary>
				</section>
