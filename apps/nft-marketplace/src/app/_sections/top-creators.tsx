...
export default function TopCreators() {
	return (
		<section>
			<div className="container lg:max-w-[1050] md:px-[1.875rem] py-10 lg:py-20 grid gap-y-10 lg:gap-y-[3.75rem]">
				<Heading
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-[1.875rem]">
