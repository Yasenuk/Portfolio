		...
		<section id="partners" className="overflow-hidden bg-bg-0 py-[88px]">
			<div className="container mb-12">
				<Reveal>
					<SectionHeading
						align="center"
						eyebrow="Надійні партнери та мережі"
						title="Працюємо з"
						highlight="найкращими"
						subtitle="Маємо прямі стосунки з преміальними рекламними мережами, афіліейт-мережами та CPA-платформами по всьому світу."
					/>
				</Reveal>
			</div>
